<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-dark-info" style="min-height: 468.162px;">
        <!-- Brand Logo -->
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview  {{isActive(['admin.users.index','admin.users.create','admin.users.edit'],'menu-open')}}">
                            <a href="#" class="nav-link  {{isActive(['admin.users.index','admin.users.create','admin.users.edit'])}}">
                                <i class="nav-icon fa fa.permissions"></i>
                                <p>
                                    کاربران
                    ...
                    <li class="nav-item has-treeview  {{isActive(['admin.permissions.index'],'menu-open')}}">
                        ...
                        <ul class="nav nav-treeview">
                            @can("show-roles")
                            <li class="nav-item">
                                <a href="{{route("admin.roles.index")}}" class="nav-link  {{isActive(['admin.permissions.index','admin.permissions.create','admin.permissions.edit'])}}">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>مقام ها</p>
                                </a>
                            </li>
                        ...
                        <li class="nav-item has-treeview  {{isActive(['admin.products.index'],'menu-open')}}">
                            <a href="#" class="nav-link  {{isActive(['admin.products.index','admin.products.create','admin.products.edit'])}}">
                                <i class="nav-icon fa fa.products"></i>
                                <p>
                                    محصولات
                                    <i class="right fa fa-angle-left"></i>
                                </p>
